...
# 명언과 귀여운 배경 이미지 매핑 (연두색 + 초원 느낌 포함, 고정 이미지 URL 사용)
quotes_with_images = [
    ("하루하루가 새로운 기회다.", "https://images.unsplash.com/photo-1502082553048-f009c37129b9?crop=entropy&cs=tinysrgb&fit=crop&h=400&w=400"),
    ...
    ("할 수 있다고 믿는 순간, 이미 반은 이룬 것이다.", "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?crop=entropy&cs=tinysrgb&fit=crop&h=400&w=400"),
    ("오늘은 어제보다 더 빛날 수 있다.", "https://images.unsplash.com/photo-1465146633010-9d27e5f7d1b1?crop=entropy&cs=tinysrgb&fit=crop&h=400&w=400"),
...
.stApp {
    ...
    background-image: url('https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?crop=entropy&cs=tinysrgb&fit=crop&h=800&w=1200');
